...
public class PrimitiveTypes {
	...
	private static void checkByte() {
		...
		System.out.println("Byte range from  " + byteMinValue + " to " + byteMaxValue);
		...
		byte otherValue = -12;
		byte otherResult = (byte) (byteValue - otherValue); // negali int sutalpinti i byte'a. bando automatiskai
															// kastinti
	...
	private static void checkShort() {
		...
		System.out.println("Short range from  " + shortMinValue + " to " + shortMaxValue);
	...
	private static void checkInt() {
		...
		System.out.println("Integer range from  " + intMinValue + " to " + intMaxValue);
	...
	private static void checkLong() {
		...
		System.out.println("Long from  " + longMinValue + " to " + longMaxValue);
	...
	private static void checkFloat() {
		...
		System.out.println("Float range from  " + floatMinValue + " to " + floatMaxValue);
		...
		System.out.println(0.1f + 0.1f + 0.1f + 0.1f + 0.1f + 0.1f + 0.1f + 0.1f + 0.1f + 0.1f); // paklaida
